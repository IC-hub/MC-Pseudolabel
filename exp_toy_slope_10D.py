...
if os.path.exists(f'toy_slope_10D/results.csv'):
    df = pd.read_csv(f'toy_slope_10D/results.csv', header=0)
else:
...
df.to_csv(f'toy_slope_10D/results.csv', index=False)
