...
parser.add_argument('--dataset_path', default='./data/power/processed', type=str)
...
hyperparameter = f'lr{args.learning_rate}_bs{args.batch_size}_reg{args.reg_lambda}_jtt{args.jtt_lambda_up}_alpha{args.alpha_threshold}_mixupsigma{args.mixup_sigma}_mixupalpha{args.mixup_alpha}'
