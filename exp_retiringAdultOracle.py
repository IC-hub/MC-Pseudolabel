...
parser.add_argument('--dataset_path', default='./data/RetiringAdult/adult/processed_occ_MIL', type=str)
...
if os.path.exists(f'retiringAdult/results1.csv'):
    df = pd.read_csv(f'retiringAdult/results1.csv', header=0)
else:
...
df.to_csv(f'retiringAdult/results1.csv', index=False)
